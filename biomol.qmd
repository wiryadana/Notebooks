...
Siklus sel terdiri dari 2 tahap besar yaitu replikasi DNA dan segregasi sel. 
Siklus sell terdiri dari 4 fase: G1, S, G2 dan M. 
Proses siklus sel bukan hanya pembelahan, tetapi juga terkait dengan pertumbuhan sel dan  proses lainnya.
...
Terdapat beberapa checkpoint siklus sel. checkpoints ukuran sel (protein dll, massa ribosomal), DNA damage.
DNA damage bisa akibat:

- faktor intrinsik
- faktor extrinsik
- Kontrol dari protein: p53 chk1

Faktor lain berpengaruh terhadap siklus sel
- mutasi faktor checkpoint
- epigenetic 
- aktivitas histon
- smallDNA atau smallRNA, panjang 10-25 nucleotida, berfungsi mengenali transkrip untuk memotong mRNA yang sesuai.
...
CDK 4/6 dan cyclin D
dari unphosphorylated pRB menjadi hypofosforilasi pRb, oleh CDK4/6-cyclinD
CDK 2 - cyclin E (post Repclication point)
...
CDK 2 dan cyclin A
dari hypo menjadi hyperforilasi pRb, oleh CDK2-cyclinA
