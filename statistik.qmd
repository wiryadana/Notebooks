...
### Induction and Deduction in Research

- Deductive reasoning is the process of reasoning from a general assumption to a specific application.
  Contoh: General proposition: all crows are black
          Specific proposition: this bird is a crow, therefore it is black

- Indcution normally involves generalization from the behavior of a few samples to that of a population
  contoh: all jasmine flowers are scented, if a situation or condition is true in all observed cases, then the situation or condition must be true in all cases.
...
### Seven Categories of plagiarism
...
a. Tulisan memenuhi kaidah ilmiah dan etika keilmuan
b. Memiliki ISSN
c. Ditulis dengan bahasa resmi PBB (inggris, france, arab, rusia, and china)
d. Memiliki terbitas versi online
e. Dikelola secara profesional
f. Editorial board pakar di bidangnya, dan berasal dari berbagai negara
g. artikel ilmiah diterbitkan dalam satu isu berasal dari penulis berbagai negara
h. memuat karya ilmiah dari penulis yang berasal dari berbagai negara dalam setiap penerbitannya
i. Terindeks database international berputasi.
...
Y~i~ = a + bX + ei (a atau b0 dan b1 adalah effect size) dan p value
...
ada 2 nilai: (rentang nilai -1 sd +1) - koefisien korelasi (rho), Ada kecenderungan hubungan x dengan y, tetapi tidak menunjukan seberapa kuat. - koefisien determinasi (r atau R^2^), seberapa persen pengaruh independen mempengaruhi dependen (effect size) - tambahan p value
